# Slippers [![Build](https://github.com/wadmiraal/slippers/actions/workflows/build.yml/badge.svg?branch=master)](https://github.com/wadmiraal/slippers/actions/workflows/build.yml)
