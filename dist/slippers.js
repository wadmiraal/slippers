...
(() => {
  ...
  function handleContainerArgs([first, ...rest]) {
    if (first.width !== void 0 || first.height !== void 0 || first.do !== void 0 || first.align !== void 0) {
      return [first, rest];
    } else {
  ...
  var VisualElement = class extends BaseElement {
    constructor(tagName, config) {
      ...
      if (config.borderStyle !== void 0) {
        this.borderStyle = config.borderStyle;
      } else if (config.borderWidth !== void 0 || config.borderRadius !== void 0 || config.borderColor !== void 0) {
  ...
  var ContainerElement = class extends VisualElement {
    constructor(tagName, config) {
      ...
      if (config.left === void 0 && config.top === void 0) {
  ...
  var App = class extends ContainerElement {
    constructor(...args) {
      ...
      if (!config || config.backgroundColor === void 0) {
